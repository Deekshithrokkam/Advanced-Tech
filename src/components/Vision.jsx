    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-5 md:px-8 text-center">
        ...
        >
          ...
          >
            To become the leading student innovation community at NIAT,
            inspiring future engineers and technologists to solve{' '}
            <span className="text-red-600">real-world challenges</span>{' '}
            through Robotics and IoT.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Build', 'Innovate', 'Lead', 'Impact', 'Collaborate'].map((v, i) => (
              <motion.span
                key={v}
