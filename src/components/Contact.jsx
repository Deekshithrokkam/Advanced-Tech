      ...
      <div className="relative z-10 max-w-5xl mx-auto px-5 md:px-8">
        ...
        >
          ...
          <div className="relative z-10 px-8 md:px-16 py-14 text-center">
            ...
            >
              Ready to innovate,{' '}
              <span className="text-red-600">build</span>,<br className="hidden sm:block" />
              and lead the future?
            </motion.h2>
            ...
            <motion.p
              ...
              transition={{ delay: 0.1 }}
            >
              Join Advanced Tech Club today. Be part of a community building real things, solving real problems, and growing fast.
            </motion.p>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <div>
              <div className="text-xs text-zinc-500 font-medium mb-1">Instagram</div>
              <div className="text-sm text-white font-semibold">@adv_club_niatxcdu</div>
            </div>
          </motion.a>
        </div>
      </div>
