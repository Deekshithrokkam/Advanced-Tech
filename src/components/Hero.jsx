      ...
      >
        ...
        >
          <span className="section-label">
            ...
            A Robotics & IoT Club of NxtWave Institute of Advanced Technologies
          </span>
        </motion.div>
        ...
        >
          ADVANCED<br />
          <span className="text-red-600 text-glow-red">TECH CLUB</span>
        </motion.h1>
        ...
        >
          Building the next generation of innovators through hands-on workshops,
          collaborative learning, and emerging technologies.
        </motion.p>
