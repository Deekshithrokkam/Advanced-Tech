...
// Generate a visually interesting placeholder image as a gradient SVG
function PlaceholderImage({ item, onClick }) {
  ...
  return (
    ...
    >
      ...
      {/* show center label when no image or when image failed to load */}
      {(!item.src || imgStatus === 'error') && (
        ...
        >
          ...
          <div className="glass px-5 py-4 flex items-center justify-between"
            ...
            <div>
              ...
              <p className="text-xs text-zinc-600 mt-0.5">Advanced Tech Club — NIAT</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-8">
          ...
          >
            ...
            <p className="text-zinc-500 max-w-lg mx-auto text-base">
              A glimpse into workshops, builds, hackathons, and the everyday magic of ATC.
            </p>
          </motion.div>
          ...
          >
            More photos coming soon — follow us on Instagram for real-time updates.
          </motion.p>
        </div>
      </section>
